...
@NgModule({
  ...
  declarations: [Tab2Page, AdviceComponent, AdviceLComponent, AdviceL2Component, BChartComponent, InxputComponent, Inxput2Component, RegionComponent, KOVComponent, KOV2Component, LagunaVerdeComponent, CultureComponent]
})
